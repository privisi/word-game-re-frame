...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_52680 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_52680(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_52685 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_52685(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_52690 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_52690(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_52696 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_52696(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_52697 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_52697(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_52700 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_52700(reader);
}
});
...
var G__52744 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__52745 = s.append(c);
c = G__52744;
s = G__52745;
continue;
}
