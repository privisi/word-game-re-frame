...
if((i < len)){
var k = (ks[i]);
var G__61424 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__61425 = (i + (1));
m = G__61424;
i = G__61425;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__61411 = c;
var G__61411__$1 = (((G__61411 == null))?null:G__61411.prototype);
if((G__61411__$1 == null)){
return null;
} else {
return G__61411__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__61413 = c;
var G__61413__$1 = (((G__61413 == null))?null:G__61413.prototype);
if((G__61413__$1 == null)){
return null;
} else {
return G__61413__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__61427__delegate = function (args){
var G__61415 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__61415) : reagent.impl.component.as_element.call(null,G__61415));
};
var G__61427 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__61428__i = 0, G__61428__a = new Array(arguments.length -  0);
while (G__61428__i < G__61428__a.length) {G__61428__a[G__61428__i] = arguments[G__61428__i + 0]; ++G__61428__i;}
  args = new cljs.core.IndexedSeq(G__61428__a,0,null);
} 
return G__61427__delegate.call(this,args);};
G__61427.cljs$lang$maxFixedArity = 0;
G__61427.cljs$lang$applyTo = (function (arglist__61429){
var args = cljs.core.seq(arglist__61429);
return G__61427__delegate(args);
});
G__61427.cljs$core$IFn$_invoke$arity$variadic = G__61427__delegate;
return G__61427;
})()
;})(c,f,_,res))
:res);
...
var G__61416 = c;
var G__61416__$1 = (((G__61416 == null))?null:G__61416.constructor);
if((G__61416__$1 == null)){
return null;
} else {
return G__61416__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__61417 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__61418 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__61418);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__61417);
}});
...
var c = this;
var G__61422_61432 = goog.object.get(c,"cljsRatom");
if((G__61422_61432 == null)){
} else {
reagent.ratom.dispose_BANG_(G__61422_61432);
}
...
var renders_61433 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_61434 = cljs.core.first(cljs.core.vals(renders_61433));
...
if((cljs.core.count(renders_61433) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_61433))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_61434)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_61434], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__61423 = o;
goog.object.set(G__61423,cljs.core.name(k),v);
