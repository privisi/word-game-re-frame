...
return shadow.util.go_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__4743__auto__);
});
...
/** @this {Function} */
(shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq58850){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq58850));
}));
...
var len__4736__auto___58928 = arguments.length;
var i__4737__auto___58929 = (0);
while(true){
if((i__4737__auto___58929 < len__4736__auto___58928)){
args_arr__4757__auto__.push((arguments[i__4737__auto___58929]));

var G__58931 = (i__4737__auto___58929 + (1));
i__4737__auto___58929 = G__58931;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq58862){
var G__58863 = cljs.core.first(seq58862);
var seq58862__$1 = cljs.core.next(seq58862);
var G__58864 = cljs.core.first(seq58862__$1);
var seq58862__$2 = cljs.core.next(seq58862__$1);
var G__58865 = cljs.core.first(seq58862__$2);
var seq58862__$3 = cljs.core.next(seq58862__$2);
var G__58866 = cljs.core.first(seq58862__$3);
var seq58862__$4 = cljs.core.next(seq58862__$3);
var G__58867 = cljs.core.first(seq58862__$4);
var seq58862__$5 = cljs.core.next(seq58862__$4);
var G__58868 = cljs.core.first(seq58862__$5);
var seq58862__$6 = cljs.core.next(seq58862__$5);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58863,G__58864,G__58865,G__58866,G__58867,G__58868,seq58862__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__58901){
var vec__58902 = p__58901;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58902,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58902,(1),null);
