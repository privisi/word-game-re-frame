...
var G__61435 = o;
goog.object.set(G__61435,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__61459__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__61459 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__61460__i = 0, G__61460__a = new Array(arguments.length -  0);
while (G__61460__i < G__61460__a.length) {G__61460__a[G__61460__i] = arguments[G__61460__i + 0]; ++G__61460__i;}
  args = new cljs.core.IndexedSeq(G__61460__a,0,null);
} 
return G__61459__delegate.call(this,args);};
G__61459.cljs$lang$maxFixedArity = 0;
G__61459.cljs$lang$applyTo = (function (arglist__61461){
var args = cljs.core.seq(arglist__61461);
return G__61459__delegate(args);
});
G__61459.cljs$core$IFn$_invoke$arity$variadic = G__61459__delegate;
return G__61459;
})()
;
} else {
...
var G__61436 = o;
goog.object.set(G__61436,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__61463__i = 0, G__61463__a = new Array(arguments.length -  0);
while (G__61463__i < G__61463__a.length) {G__61463__a[G__61463__i] = arguments[G__61463__i + 0]; ++G__61463__i;}
  args = new cljs.core.IndexedSeq(G__61463__a,0,null);
} 
return G__61462__delegate.call(this,args);};
G__61462.cljs$lang$maxFixedArity = 0;
G__61462.cljs$lang$applyTo = (function (arglist__61464){
var args = cljs.core.seq(arglist__61464);
...
var G__61437 = props;
var G__61437__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61437,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__61437);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61437__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__61437__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__61438 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61438,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__61438;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__61439){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61440__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__61442_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__61442_SHARP_);
}));
} else {
return null;
}
...
var vec__61444 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61444,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61444,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61444,(2),null);
...
var temp__5739__auto___61466 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___61466 == null)){
} else {
var key_61467 = temp__5739__auto___61466;
(jsprops.key = key_61467);
}
...
var temp__5739__auto___61468 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___61468 == null)){
} else {
var key_61469 = temp__5739__auto___61468;
(jsprops.key = key_61469);
}
...
var G__61448 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__61448) : reagent.impl.template.as_element.call(null,G__61448));
} else {
var temp__5739__auto___61470 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___61470 == null)){
} else {
var key_61471 = temp__5739__auto___61470;
(jsprops.key = key_61471);
}
...
var G__61450 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__61450)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__61450)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq61451){
var G__61452 = cljs.core.first(seq61451);
var seq61451__$1 = cljs.core.next(seq61451);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61452,seq61451__$1);
}));
...
break;
default:
var G__61476 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__61476;
continue;
...
var ctx = ({});
var vec__61455 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61455,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61455,(1),null);
...
var G__61458 = (cljs.core.count(argv) - first_child);
switch (G__61458) {
case (0):
